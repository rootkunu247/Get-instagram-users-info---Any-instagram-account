...
def main():
        try:
            ...
            + - -- [ BY KADA ]
            + - -- [ v 1.0 ]
	    + - -- [ For v2.0 PRO - Text me on Telegram : @Ghost7_Kada ]
	    + - -- [ PRO V2.0 - Can get all instagram users info and save them - You just need to set users list ]
            + - -- [ Get Instagram user info ]

	* if you found any ERRORS please text me [ facebook.com/zxlll ] or Telegram @Ghost7_Kada
	* Make sure username is correct **

	//////  EXIT USER : CTRL + C + ENTER  \\\\\\

	#########################################   #  ##### ###### #####  #
	# * to get info using list contact me * #  # NEVER USE FOR CHECKING #
	#########################################   #  ##### ###### #####  #
''' + W
                info()
        except IOError :
